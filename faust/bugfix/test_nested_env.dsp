// Test case: NESTED environment { } structure (K28 only)
// Expected: UNKNOWN - testing if environment scoping fixes the issue
...
// Environment wrapper containing the function
tape_env = environment {
...
process = par(i, 2, tape_env.tape_channel_ui);
