// Test case: NESTED with { } structure (ALL K modes)
// Expected: BROKEN - flat noise floor, aliasing artifacts
// Structure: tape_channel is a FUNCTION with parameters (library pattern)
//
// This file tests if nesting everything inside a function's with { } block
// breaks rdtable lookups. Compare with test_full_flat.dsp (working reference).
...
//==============================================================================
// tape_channel: Main processing function (LIBRARY PATTERN)
//
// This is the structure recommended by GRAME for library contributions:
// Everything nested inside a function's with { } block.
//
// Parameters:
